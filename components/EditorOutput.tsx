        ...
        <div className="prose dark:prose-invert max-w-none">
            {content.blocks.map((block, index) => {
                switch (block.type) {
                    ...
                    case "list":
                        const rawItems: any[] = Array.isArray(block.data?.items)
                            ? block.data.items
                            : [];
                    ...
                    case "checklist":
                        const checklistItems = Array.isArray(block.data?.items)
                            ? block.data.items
                            : [];
                        return (
                            <div key={index}>
                    ...
                    case "linkTool":
                        ...
                        return (
                            <div
                                key={index}
                                className="border rounded p-4 my-4 bg-gray-50"
                            >
                                <a
                                    href={link}
                                    target="_blank"
